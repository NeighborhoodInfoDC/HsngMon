/**************************************************************************
 ...
 D:\DCData\Libraries\HsngMon\Reports\2006-3\S8summary_2006_3.xls (must
...
%let rpt_xls  = S8summary_2006_3.xls;
%let map_file = S8summary_2006_3;
...
proc freq data=HsngMon.S8summary_2006_3;
  tables rpt_status;
run;

** Print list of active, renewed and expired projects **;

proc print data=HsngMon.S8summary_2006_3;
...
proc summary data=HsngMon.S8summary_2006_3;
...
proc summary data=HsngMon.S8summary_2006_3 completetypes;
...
proc summary data=HsngMon.S8summary_2006_3 completetypes nway;
...
proc compare base=HsngMon.S8summary_2006_2 compare=HsngMon.S8summary_2006_3 maxprint=(100,32000)
             out=result (drop=_obs_ rename=(_type_=Report)) outnoequal outbase outcomp noprint;
  id contract_number cur_address_line1_text ward2002;
  var cur_assisted_units_count rpt_status cur_expiration_date;
run;
...
proc print data=result noobs;
   ...
   *title3 "BASE=feb06, COMPARE=jul06";
run;
