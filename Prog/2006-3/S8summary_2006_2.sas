...
proc print data=Sec8MF_sum_rpt;
...
proc summary data=Sec8MF_sum_rpt;
...
proc summary data=Sec8MF_sum_rpt completetypes;
...
proc summary data=Sec8MF_sum_rpt completetypes nway;
