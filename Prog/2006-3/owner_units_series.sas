...
data Parcel_qtr (compress=no);
  ...
  ** Count units in each quarter **;
  ** Note:  Unit is counted if it existed at any time during the quarter **;
...
filename fexport "D:\DCData\Libraries\HsngMon\Reports\2006-3\Owner_units_series.csv" lrecl=1000;
