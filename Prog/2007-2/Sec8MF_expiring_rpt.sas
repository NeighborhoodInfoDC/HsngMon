...
%let cur_rpt_date = '01oct2006'd; 
%let rpt_title = Spring 2007;
%let data = HsngMon.S8summary_2007_2 /*Hud.Sec8mf_current_dc_feb07*/;
/*%let data = Hud.Sec8mf_2006_07_dc;*/
%let hud_file_date = '2/6/07';
%let num_qtrs = 4;
%let num_years = 9;
%let rpt_path = &_dcdata_path\HsngMon\Prog\2007-2;
%let rpt_name = S8expiring_2007_2;
...
data SEC8MF;
  ...
  if inHUD and not( missing( cur_expiration_date /*tracs_overall_expiration_date*/ ) ) and
     not( missing( put( cur_expiration_date /*tracs_overall_expiration_date*/, nextqtrs. ) ) );
  
  ***where '01apr2005'd <= cur_expiration_date /*tracs_overall_expiration_date*/ < '01apr2006'd;
  
  contracts = 1;
  
  quarter = cur_expiration_date /*tracs_overall_expiration_date*/;
...
proc sort 
  data=SEC8MF;
  by cur_expiration_date /*tracs_overall_expiration_date*/;
...
ods rtf file="&rpt_path\&rpt_name._sum.rtf" style=Styles.Rtf_arial_9pt/*Rtf_arial_9pt_grhd*/;
ods listing close;

proc report data=SEC8MF list nowd split='*';
  column quarter contracts cur_address_line1_text cur_expiration_date /*tracs_overall_expiration_date*/
         /*risk*/ ta_cur_provider cur_assisted_units_count /*assisted_units_count*/owner_organization_name;
  ...
  define cur_expiration_date /*tracs_overall_expiration_date*/ / display format=mmddyy10. 'Expires';
...
data detail_dat (keep=cur_expiration_date /*tracs_overall_expiration_date*/ buff rownum);
...
ods rtf file="&rpt_path\&rpt_name._det.rtf" style=Styles.Rtf_arial_9pt/*Rtf_arial_9pt_grhd*/;
ods listing close;
...
proc report data=detail_dat list nowd noheader;
  ...
  define buff / display;
  format 
    cur_expiration_date /*tracs_overall_expiration_date*/ nextqtrs.;
