...
proc summary data=HsngMon.Foreclosures_1999_2009 nway;
  where ui_instrument = 'F1' and ui_proptype in ( '10', '11', '12', '13' ) and filingdate < "01jan&last_year"d;
...
proc summary data=HsngMon.Foreclosures_1999_2009 nway;
  where ui_instrument = 'F1' and ui_proptype in ( '10', '11', '12', '13' ) and /*filingdate < '01oct2009'd*/ 
    filingdate <= intnx( 'qtr', "01jan&last_year"d, &last_qtr - 1, 'end' ) and 1 <= qtr( filingdate ) <= &last_qtr.;
  class filingdate ssl;
  id ui_proptype;
  format filingdate year4.;
