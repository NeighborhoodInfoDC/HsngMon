/**************************************************************************
 Program:  Forecl_year_ward_cht.sas
 Library:  HsngMon
 ...
 Description: Create CSV files for foreclosure indicators by year, ward:
...
proc summary data=HsngMon.Foreclosures_year_2009_3 nway;
...
%macro Export( var=, prefix= );
  ...
  proc transpose data=Chart_units 
    ...
    id ward2002;
    by report_dt;
    format ward2002 $1. report_dt year4.;
...
%Export( var=in_foreclosure_beg_rate, prefix=forecl_year_ward_inv )

%Export( var=foreclosure_start_rate, prefix=forecl_year_ward_start )

%Export( var=foreclosure_sale_rate, prefix=forecl_year_ward_sale )
