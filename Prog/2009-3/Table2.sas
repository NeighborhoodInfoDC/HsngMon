/**************************************************************************
 ...
 FIRST QUARTER COMPARISONS ONLY
...
%Init_macro_vars( rpt_yr=2009, rpt_qtr=3, sales_qtr_offset=-2 )

%let sheet = Table 2;

%let row_suffix = Q1-Q2;
...
filename xlsFile dde "excel|&g_path\[&g_table_wbk]&sheet!r10c2:r22c9" lrecl=1000 notab;
...
data _null_;
  ...
  ** Supress time on market data before 2001 **;
  ...
  xmonth = put( month, year4. ) || " &row_suffix";
