...
%Init_macro_vars( rpt_yr=2010, rpt_qtr=4, sales_qtr_offset=-2 )
...
data &out (label="Clean property sales for &g_rpt_title Housing Monitor" compress=no);
  ...
  keep ssl saleprice saledate ui_proptype ward2002 cluster_tr2000 geo2000 saledate_yr owner_occ_sale
