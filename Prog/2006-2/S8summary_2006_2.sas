/**************************************************************************
 ...
 D:\DCData\Libraries\HsngMon\Reports\2006-2\S8summary_2006_2.xls (must
 be open before running program).
...
/*%let cur_rpt_date = '31mar2006'd; */
%let cur_rpt_date = '01jan2006'd;
%let rpt_title = Summer 2006;
%let data = Hud.Sec8mf_current_dc_feb06;
%let num_qtrs = 4;
%let num_years = 9;
%let rpt_path = D:\DCData\Libraries\HsngMon\Reports\2006-2;
%let rpt_xls  = S8summary_2006_2.xls;
%let map_file = S8summary_2006_2;
...
data RptDate (compress=no);
  ...
  /*
  rpt_date = trim( left( put( &cur_rpt_date, monname. ) ) ) || ' ' || 
             trim( left( put( &cur_rpt_date, year4. ) ) );
  */
...
%Write_dde( sheet=City, range=r2c1:r2c1, data=RptDate, var=rpt_date )
%Write_dde( sheet=City, range=r53c1:r53c1, data=RptDate, var=rpt_date )

** Create data for tables **;

data HsngMon.S8summary_2006_2;
    ...
    ** Active contracts **;
    ...
    if cur_expiration_date > prev_expiration_date and
      ...
      ** Renewed contracts (past four quarters) **;
      ...
      ren_contract_len = intck( 'YEAR', prev_expiration_date, cur_expiration_date );
...
proc freq data=HsngMon.S8summary_2006_2;
  tables rpt_status;
run;

** Print list of active, renewed and expired projects **;

proc print data=HsngMon.S8summary_2006_2;
  where act_contracts > 0;
  id contract_number;
  var date_cur_contract cur_expiration_date prev_expiration_date 
...
proc print data=HsngMon.S8summary_2006_2;
  ...
  id contract_number;
  var exp_ren_date date_cur_contract cur_expiration_date prev_expiration_date 
...
proc summary data=HsngMon.S8summary_2006_2;
...
proc summary data=HsngMon.S8summary_2006_2 completetypes;
...
proc summary data=HsngMon.S8summary_2006_2 completetypes nway;
