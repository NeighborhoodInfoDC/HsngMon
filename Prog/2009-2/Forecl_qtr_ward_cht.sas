...
%macro Export( var=, prefix= );
  ...
  filename fexport "&_dcdata_path\HsngMon\Prog\2009-2\&prefix..csv" lrecl=256;
...
%Export( var=in_foreclosure_beg_rate, prefix=forecl_inv_wd )

%Export( var=foreclosure_start_rate, prefix=forecl_start_wd )

%Export( var=foreclosure_sale_rate, prefix=forecl_sale_wd )
