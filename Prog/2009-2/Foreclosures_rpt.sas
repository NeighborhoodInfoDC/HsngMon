/**************************************************************************
 ...
 Modifications:
   05/19/09  Added USECODE, GEO2000 to output data set.
**************************************************************************/
...
%Foreclosures( out_ds=HsngMon.Foreclosures_qtr_2009_2, unit=qtr, rpt_end_dt='31mar2009'd )

%Foreclosures( out_ds=HsngMon.Foreclosures_year_2009_2, unit=year, rpt_end_dt='31dec2008'd )


proc compare base=HsngMon.foreclosures_qtr_2009_2_050609 compare=HsngMon.foreclosures_qtr_2009_2 maxprint=(40,32000);
  id ssl report_dt;
run;
