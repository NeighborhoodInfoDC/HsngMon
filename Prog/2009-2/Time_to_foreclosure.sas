...
data time_to_foreclosure;
  ...
  ** Set episode dates **;
  ...
  if '01jan1999'd <= start_dt < '01jan2009'd;
...
ods rtf file="&_dcdata_path\HsngMon\prog\2009-2\Time_to_foreclosure.rtf" style=Styles.Rtf_arial_9pt;
ods html body="&_dcdata_path\HsngMon\prog\2009-2\Time_to_foreclosure.html" style=Minimal;


options nodate;

proc tabulate data=Time_to_foreclosure format=comma10.0 noseps missing;
  where '01jan1999'd <= start_dt < '01apr2008'd;
...
proc tabulate data=Time_to_foreclosure format=comma10.0 noseps missing;
  where '01jan2007'd <= start_dt < '01jan2009'd;
  class ui_proptype start_dt;
  var days;
  table 
    /** Rows **/
