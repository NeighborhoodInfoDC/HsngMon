...
data Num_own_units (compress=no);
  ...
  set RealProp.Num_units_wd02 
      (keep=ward2002 
            units_owner_2000-units_owner_2006 
            units_condo_2000-units_condo_2006 
            units_coop_2000-units_coop_2006
            units_sf_2000-units_sf_2006);

  array owner{*} units_owner_2000-units_owner_2006;
  array ch_owner{*} ch_units_owner_2000-ch_units_owner_2006;
  
  do i = 1 to dim( owner );
    ch_owner{i} = owner{i} - owner{1};
  end;

  array sf{*} units_sf_2000-units_sf_2006;
  array ch_sf{*} ch_units_sf_2000-ch_units_sf_2006;
  
  do i = 1 to dim( sf );
    ch_sf{i} = sf{i} - sf{1};
  end;

  array condo{*} units_condo_2000-units_condo_2006;
  array ch_condo{*} ch_units_condo_2000-ch_units_condo_2006;
  
  do i = 1 to dim( condo );
    ch_condo{i} = condo{i} - condo{1};
  end;

  array coop{*} units_coop_2000-units_coop_2006;
  array ch_coop{*} ch_units_coop_2000-ch_units_coop_2006;
