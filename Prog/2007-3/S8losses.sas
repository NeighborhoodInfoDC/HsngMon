...
%Write_dde( sheet=Titles, range=r8c2:r8c2, data=PreservationTitles, var=preservation_per )
%Write_dde( sheet=Titles, range=r9c2:r9c2, data=PreservationTitles, var=start_date )
