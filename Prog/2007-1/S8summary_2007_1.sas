/**************************************************************************
 ...
 clusters.  Writes to Excel file
   D:\DCData\Libraries\HsngMon\Prog\2007-1\S8summary_2007_1.xls 
...
%let rpt_title = Winter 2007;
%let data = Hud.Sec8mf_current_dc_sep06;
%let hud_file_date = '9/5/06';
%let num_qtrs = 4;
%let num_years = 9;
%let rpt_path = &_dcdata_path\HsngMon\Prog\2007-1;
%let rpt_xls  = S8summary_2007_1.xls;
%let map_file = S8summary_2007_1;
...
proc print data=HsngMon.S8summary_2007_1;
...
proc summary data=HsngMon.S8summary_2007_1;
...
proc summary data=HsngMon.S8summary_2007_1 completetypes;
...
/*
proc freq data=HsngMon.S8summary_2007_1;
...
proc summary data=HsngMon.S8summary_2007_1 completetypes nway;
...
proc compare base=HsngMon.S8summary_2006_3 compare=HsngMon.S8summary_2007_1 maxprint=(100,32000)
