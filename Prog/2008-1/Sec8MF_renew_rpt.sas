...
%let rpt_file = S8renew_&g_rpt_yr._&g_rpt_qtr;

%prevqtrs_format( date=&g_s8_rpt_dt, label_prefix=%str(\line\ql\keepn\i Renewed ), month_fmt=monname20. )
...
%Renew_rpt( ta_data = Nas.ta_proj_list_2007_07 )
