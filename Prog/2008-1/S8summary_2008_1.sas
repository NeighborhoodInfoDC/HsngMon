/**************************************************************************
 ...
 clusters.  Writes to Excel file
   d:\DCData\Libraries\HsngMon\Prog\2008-1\S8summary_2008_1.xls 
 (must be open before running program).
 
 NB: Download latest versions of Hud.Sec8mf_current_dc and 
     Hud.Sec8mf_history_dc from Alpha before running this program.
 ...
 02/04/08 PAT Added unit count corrections.
**************************************************************************/
...
%let dde = y;                          %** Send output to DDE (Y/N) **;
...
data HsngMon.&rpt_file;
  ...
  ** Corrections (02/04/08) **;
  
  select ( contract_number );
    when ( 'DC39L000016' ) do;
      prev_assisted_units_count = 36;
      cur_assisted_units_count = 36;
    end;
    when ( 'DC39L000013' ) do;
      prev_assisted_units_count = 45;
      cur_assisted_units_count = 45;
    end;
    when ( 'DC39L000075' ) do;
      prev_assisted_units_count = 266;
      prev_total_unit_count = 266;
      cur_assisted_units_count = 266;
      cur_total_unit_count = 266;
    end;
    when ( 'DC39L000078' ) do;
      prev_assisted_units_count = 76;
      prev_total_unit_count = 76;
      cur_assisted_units_count = 76;
      cur_total_unit_count = 76;
    end;
    when ( 'DC39M000046' ) do;
      prev_assisted_units_count = 72;
      cur_assisted_units_count = 72;
    end;
    when ( 'DC39T802001' ) do;
      prev_assisted_units_count = 6;
      cur_assisted_units_count = 6;
    end;
    when ( 'DC390005009' ) do;
      prev_assisted_units_count = 97;
      cur_assisted_units_count = 97;
    end;
    when ( 'DC39M000033' ) do;
      prev_assisted_units_count = 122;
      cur_assisted_units_count = 122;
    end;
    otherwise
      /** Do nothing **/;
  end;
