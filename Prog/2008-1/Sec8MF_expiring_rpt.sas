...
%let rpt_file = S8expiring_&g_rpt_yr._&g_rpt_qtr;
...
%nextqtrs_format( date=&g_s8_rpt_dt, label_prefix=%str(\line\ql\keepn\i Expiring ), month_fmt=monname20. )
...
proc report data=SEC8MF list nowd split='*';
  ...
  define cur_expiration_date  / display format=mmddyy8. 'Expires';
  ...
  title2 height=11pt "District of Columbia Housing Monitor: &g_rpt_title";
